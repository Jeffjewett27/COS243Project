    ...
    handleSubmit: function () {
      ...
      this.$axios
        .post("/reset-password", {
          ...
          curPassword: this.newMember.curPassword,
          newPassword: this.newMember.newPassword,
          confirmPassword: this.newMember.confirmPassword,
        })
        .then((result) => {
